 ...
 * This demonstrates how to interact with the Hyperion MCP Server
 */
...
class MCPBalanceExample {
  ...
  async runFullDemo() {
    console.log('🎯 Hyperion MCP Server - Live Balance Demo');
    console.log('==========================================\n');
...
async function main() {
  ...
  if (args.includes('--examples') || args.includes('-e')) {
    ...
    console.log('🎯 Hyperion MCP Server - Balance Tool Demo');
    console.log('==========================================\n');
