...
async function testBalanceDirectly() {
  console.log('🧪 Testing Hyperion Client Balance Functionality');
  console.log('================================================\n');

  try {
    // Initialize the Hyperion client with a public RPC endpoint
    const config = {
...
async function demonstrateMCPTools() {
  ...
  "mcpServers": {
    "hyperion-mcp": {
      ...
      "args": ["build/index.js"],
      "env": {
        "HYPERION_RPC_URL": "https://your-rpc-url",
  ...
  console.log('docker run -e HYPERION_RPC_URL=your_url hyperion-mcp\n');
...
async function main() {
  console.log('🚀 Hyperion MCP Server - Comprehensive Test Suite');
  console.log('==================================================\n');
